...
export async function generateMetadata({
  ...
  // `og:image` is generated by the sibling `opengraph-image.tsx` route —
        ...
        <div className="flex items-start gap-6 border-b pb-8">
          ...
          <div className="flex-1">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {/* "Message" deep-links into the signed-in messages thread. If the
                  viewer isn't signed in, the dashboard layout will bounce them
                  to /login first, then back here on success. */}
              <Link
                href={`/dashboard/messages/${profile.user.id}`}
                className="inline-flex items-center gap-1.5 rounded-full bg-primary text-primary-foreground px-3 py-1.5 text-xs font-medium hover:bg-primary/90 transition"
              >
                Message
              </Link>
            </div>
